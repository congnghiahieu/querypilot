...
from src.nl2sql.dail_sql.utils.utils import get_tables, sql2skeleton
from src.nl2sql.dail_sql.utils.linking_utils.application import get_question_pattern_with_schema_linking
