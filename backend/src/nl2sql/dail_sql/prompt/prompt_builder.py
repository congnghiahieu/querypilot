from src.nl2sql.dail_sql.utils.enums import REPR_TYPE
from src.nl2sql.dail_sql.utils.enums import EXAMPLE_TYPE
from src.nl2sql.dail_sql.utils.enums import SELECTOR_TYPE
