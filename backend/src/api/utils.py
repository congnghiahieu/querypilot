...
def paging(data: list[Any], page_number=1, page_size=20, total_count=0, start_page_as_1=True):
    ...
    total_pages = total_count // page_size + 1 if remaining else total_count // page_size
