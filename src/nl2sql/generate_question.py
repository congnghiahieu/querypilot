...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_type", type=str, choices=["spider", "bird", "bull"], default="spider")
    ...
    parser.add_argument("--max_seq_len", type=int, default=8000, help="The maximal length that LLM takes")
    parser.add_argument("--max_ans_len", type=int, default=4000, help="The maximal length that an answer takes")
    ...
    cost_deepseek_v3 = cost_estimate(n_total_tokens, LLM.DEEP_SEEK_V3)
    ...
    print(f"Estimated cost for {LLM.DEEP_SEEK_V3}: {cost_deepseek_v3}")
